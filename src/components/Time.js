...
const Time = () => {
  ...
  const isDay = currentHour > 5 && currentHour < 12;
  const isAfternoon = currentHour > 12 && currentHour < 18;

  // console.log(isDay ? 'Good Morning' : 'Good Afternoon');
  // console.log(isAfternoon ? 'Good Afternoon' : 'Good Evening');
  console.log(
    isDay ? 'Good Morning' : isAfternoon ? 'Good Afternoon' : 'Good Evening'
  );
